...
from khang_net.configs.yolof.coco_dataloader_train_val import dataloader
from khang_net.configs.huflit_net.huflitnet_r_50_se import model

dataloader.train.mapper.use_instance_mask = True
dataloader.train.total_batch_size = 16

train['output_dir'] = "./output_huflitnet_r_50_se_1x_train_val"
