...
from khang_net.configs.yolof.coco_schedule import lr_multiplier_3x_b10 as lr_multiplier
from khang_net.configs.yolof.coco_dataloader import dataloader
from khang_net.configs.yolof_mask.yolofmask_r_101_se import model
...
train['output_dir'] = "./output_yolofmask_r_101_se_3x"
