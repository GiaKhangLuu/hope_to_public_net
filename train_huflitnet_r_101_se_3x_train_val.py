...
config_file = "khang_net/configs/huflit_net/huflitnet_r_101_se_3x.py"
...
cfg.train['output_dir'] = "./output_huflitnet_r_101_se_3x_train_val"
cfg.train['max_iter'] = 432000
cfg.train['eval_period'] = 432000
